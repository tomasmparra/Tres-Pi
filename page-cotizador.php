...
<main class="budget budget_page_0">
  ...
  <div class="budget_body budget_body_0">
		<div class="budget_group" id="budget_1" onclick="altClassFromSelector('budget_a_display', '#budget_1', ['budget_group'])">
			<p class="budget_q budget_text">¿Cuál es tu presupuesto para este sitio?</p>
			<div class="budget_arrow">
					<?= file_get_contents(get_template_directory_uri() . '/assets/circle_arrow_small.svg') ?>
			</div>
			<p class="budget_a budget_text budget_text_sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
			<div class="budget_deco"></div>
		</div>

    <div class="budget_group" id="budget_2" onclick="altClassFromSelector('budget_a_display', '#budget_2', ['budget_group'])">
			<p class="budget_q budget_text">¿Que tipo de web necesitas?</p>
			<div class="budget_arrow">
					<?= file_get_contents(get_template_directory_uri() . '/assets/circle_arrow_small.svg') ?>
			</div>
			<p class="budget_a budget_text budget_text_sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
    ...
    <div class="budget_group" id="budget_3" onclick="altClassFromSelector('budget_a_display', '#budget_3', ['budget_group'])">
      <p class="budget_q budget_text">¿Necesitas hosting?</p>
      <div class="budget_arrow">
        <?= file_get_contents(get_template_directory_uri() . '/assets/circle_arrow_small.svg') ?>
      </div>
      <p class="budget_a budget_text budget_text_sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
    ...
    <div class="budget_group" id="budget_4" onclick="altClassFromSelector('budget_a_display', '#budget_4', ['budget_group'])">
      <p class="budget_q budget_text">¿Necesitas servicios de diseño web o marketing?</p>
      <div class="budget_arrow">
        <?= file_get_contents(get_template_directory_uri() . '/assets/circle_arrow_small.svg') ?>
      </div>
      <p class="budget_a budget_text budget_text_sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
