...
<section class="dropdowny_box" style="display:none">
...
<section class="slidey" style="display:none">
...
<section class="blurb_box" style="display:none">
...
<section class="big_pics" style="display:none">
